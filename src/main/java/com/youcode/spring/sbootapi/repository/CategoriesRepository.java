...
public interface CategoriesRepository extends JpaRepository<Category, Long> {
    ...
    @Query("select new com.youcode.spring.sbootapi.models.extensions.CategoryExtension(c.id, c.name, p.id) from Category c inner join c.products as p where p.id in :ids")
